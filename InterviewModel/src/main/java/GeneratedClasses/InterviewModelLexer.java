...
public class InterviewModelLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INTERVIEW_TITLE", "DATE_TITLE", "ABOUT_TITLE", "EMAIL_TITLE", "REQUIREMENT", 
			"ANSWER", "TRUE_FALSE_QUESTION", "SHORT_ANSWER_QUESTION", "SINGLE_CHOICE_QUESTION", 
			"MULTIPLE_CHOICE_QUESTION", "INTEGER_QUESTION", "DECIMAL_QUESTION", "DATE_QUESTION", 
			"TIME_QUESTION", "NUMERIC_SCALE_QUESTION", "HIFEN", "DIGITO", "INTEIRO", 
			"DATE", "DIA", "MES", "ANO", "DECIMAL", "TIME", "CHOICE_ANSWER", "NEWLINE", 
			"DESCRIPTION_TEXT"
		};
	}
