...
void getInfoFromUser(char *inputDir, char *outputDir, unsigned int *timeInterval) {
    printf("\n------------------------------------------------------------------------------------------------\n\n");
    ...
    if (timeChoice == 's' || timeChoice == 'S') {
        *timeInterval = TIME_INTERVAL;
        ...
        // strtol para converter a entrada para um long int
        char intervalStr[20];
        scanf("%s", intervalStr);
        char *endptr;
        ...
        if (*endptr != '\0') {
            ...
            *timeInterval = (unsigned int) interval;
        }
    }
    printf("\n---------------------------------------------------------------------\n");
}
...
#ifndef TESTING
int main() {
    char inputDir[EXTENDED_PATH_LENGTH];
    char outputDir[EXTENDED_PATH_LENGTH];
